#!/usr/bin/env bash
# from https://github.com/nikitabobko/AeroSpace/issues/296
# also has more interesting ideas for yabai.. which maybe can be adapted? https://github.com/farhantamzid/dotfiles/blob/main/yabai/.config/yabai/toggle_safari.sh
